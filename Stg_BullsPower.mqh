...
class Stg_BullsPower : public Strategy {
 public:
  Stg_BullsPower(StgParams &_params, Trade *_trade = NULL, string _name = "") : Strategy(_params, _trade, _name) {}
  ...
  static Stg_BullsPower *Init(ENUM_TIMEFRAMES _tf = NULL, long _magic_no = NULL, ENUM_LOG_LEVEL _log_level = V_INFO) {
    ...
    Strategy *_strat = new Stg_BullsPower(_stg_params, new Trade(new Chart(_tf, _Symbol)), "BullsPower");
    return _strat;
  }
